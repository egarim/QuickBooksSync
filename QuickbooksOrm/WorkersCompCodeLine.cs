...
namespace QuickBooksSync.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        public const string QueryableProperties="Id,WorkersCompCodeId,Name,Desc,CurrentRate,CurrentEffectiveDate,NextRate,NextEffectiveDate,RateHistoryRate,RateHistoryEffectiveDate,IsActive,TimeCreated,TimeModified,EditSequence";
        public const string QuickbooksTableName="WorkersCompCodeLines";
    }
}