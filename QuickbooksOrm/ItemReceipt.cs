...
namespace QuickBooksSync.Module.BusinessObjects
{
    ...
    public class ItemReceipt : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public ItemReceipt(Session session)
            : base(session)
        {
        }
        ...
        public const string QueryableProperties="Id,VendorName,VendorId,Date,ReferenceNumber,AccountsPayable,AccountsPayableId,Memo,Amount,TxnNumber,ExchangeRate,IsTaxIncluded,ItemCount,ItemAggregate,ExpenseItemCount,ExpenseItemAggregate,TransactionCount,TransactionAggregate,CustomFields,EditSequence,TimeModified,TimeCreated";
        public const string QuickbooksTableName="ItemReceipts";
    }
}