...
namespace QuickBooksSync.Module.BusinessObjects
{
    ...
    public class EstimateLinkedTransaction : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public EstimateLinkedTransaction(Session session)
            : base(session)
        {
        }
        ...
        public const string QueryableProperties="Id,EstimateId,ReferenceNumber,TxnNumber,CustomerName,CustomerId,Date,TransactionId,TransactionAmount,TransactionDate,TransactionReferenceNumber,TransactionType,TransactionLinkType,TimeModified,TimeCreated";
        public const string QuickbooksTableName="EstimateLinkedTransactions";
    }
}