...
namespace QuickBooksSync.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        {
            get => _Deposit;
            set => SetPropertyValue(nameof(Deposit), ref _Deposit, value);
        }  
        ...
        private string _ItemAccountNavigation;
        public string ItemAccountNavigation
        {
            get => _ItemAccountNavigation;
            set => SetPropertyValue(nameof(ItemAccountNavigation), ref _ItemAccountNavigation, value);
        }  
        ...
        private string _ItemPaymentMethodNavigation;
        public string ItemPaymentMethodNavigation
        {
            get => _ItemPaymentMethodNavigation;
            set => SetPropertyValue(nameof(ItemPaymentMethodNavigation), ref _ItemPaymentMethodNavigation, value);
        }  
