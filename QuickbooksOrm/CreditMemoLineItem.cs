...
namespace QuickBooksSync.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        public const string QueriableProperties="Id,CreditMemoId,ReferenceNumber,TxnNumber,Date,CustomerName,CustomerId,AccountsReceivable,AccountsReceivableId,ShipMethod,ShipMethodId,ShipDate,Memo,Amount,Message,MessageId,SalesRep,SalesRepId,Fob,BillingAddress,BillingLine1,BillingLine2,BillingLine3,BillingLine4,BillingLine5,BillingCity,BillingState,BillingPostalCode,BillingCountry,BillingNote,ShippingAddress,ShippingLine1,ShippingLine2,ShippingLine3,ShippingLine4,ShippingLine5,ShippingCity,ShippingState,ShippingPostalCode,ShippingCountry,ShippingNote,Subtotal,Tax,TaxItem,TaxItemId,TaxPercent,IsPending,IsToBeEmailed,IsToBePrinted,IsTaxIncluded,Ponumber,Terms,TermsId,CreditRemaining,DueDate,Template,TemplateId,CustomerSalesTax,CustomerSalesTaxId,Class,ClassId,ExchangeRate,CustomFields,ItemLineId,ItemLineNumber,ItemName,ItemId,ItemGroup,ItemGroupId,ItemDescription,ItemUnitOfMeasure,ItemQuantity,ItemRate,ItemRatePercent,ItemTaxCode,ItemTaxCodeId,ItemAmount,ItemClass,ItemClassId,ItemInventorySiteName,ItemInventorySiteId,ItemInventorySiteLocationName,ItemInventorySiteLocationId,ItemSerialNumber,ItemLotNumber,ItemOther1,ItemOther2,ItemCustomFields,ItemUomsetFullName,ItemUomsetListId,ItemIsGetPrintItemsInGroup,EditSequence,TimeModified,TimeCreated,AccountsReceivableNavigation,ClassNavigation,CreditMemo,Customer,CustomerSalesTaxNavigation,Item,ItemClassNavigation,ItemGroupNavigation,ItemInventorySite,ItemTaxCodeNavigation,ItemUomsetList,MessageNavigation,SalesRepNavigation,ShipMethodNavigation,TaxItemNavigation,TemplateNavigation";
    }
}