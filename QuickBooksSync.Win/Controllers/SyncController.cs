...
namespace QuickBooksSync.Module.Controllers
{
    ...
    public partial class SyncController : ViewController
    {
        ...
        private void Sybc_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            List<string> Entities = new List<string>() { "Account" };
            foreach (string entity in Entities)
            {
                var EntityType = this.Application.TypesInfo.FindTypeInfo("QuickBooksSync.Module.BusinessObjects." + entity);
                ...
                var WokerArgs = (currentCompany.FilePath, entity, QueryableProperties, EntityType.Type);
